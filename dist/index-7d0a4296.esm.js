...
`;let Ct=class t extends ht{constructor(){super(...arguments);this.closeChatIcon=""}handleCloseChat(){var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)}render(){return z`
		...
		`}};Ct.styles=[xt,At];t([gt({type:String})],Ct.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],Ct.prototype,"onCloseChat",void 0);Ct=t([ct("chat-header")],Ct);var Et=Object.freeze({__proto__:null,get ChatHeader(){return Ct}});function wt(t,e,s){return t?e():null==s?void 0:s()}const St={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Tt=t=>(...e)=>({_$litDirective$:t,values:e});class Mt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class It extends Mt{constructor(t){if(super(t),this.et=q,t.type!==St.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===q||null==t)return this.ft=void 0,this.et=t;if(t===V)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}}It.directiveName="unsafeHTML",It.resultType=1;const kt=Tt(It);const Nt=a`
...
`;let Pt=class t extends ht{constructor(){super(...arguments);this.timestamp=""}get displayTimestamp(){const t={hour:"2-digit",minute:"2-digit"};return new Intl.DateTimeFormat(navigator.language,t).format(this.date)}render(){return z`
		...
		`}};Pt.styles=[xt,Nt];t([gt({type:String})],Pt.prototype,"timestamp",void 0);t([gt({type:Date})],Pt.prototype,"date",void 0);Pt=t([ct("timestamp-divider")],Pt);const Ot=a`
	.chat-container {
...
`;const Ut={BOT:"https://assets.pharmeasy.in/web-assets/images/image_chatbot.png",SEND_MESSAGE_ENABLE:"https://assets.pharmeasy.in/web-assets/images/icon_sendMessage.svg",SEND_MESSAGE_DISABLE:"https://assets.pharmeasy.in/web-assets/images/icon_sendMessage_disable.svg",CLOSE_CHAT:"https://assets.pharmeasy.in/web-assets/images/ic_close.svg",PHONE:"https://assets.pharmeasy.in/web-assets/images/callPhoneFilledWhite.svg"};const Bt={CUSTOMER_CARE_NUMBER:"1800 208 5555"};let Ht=class t extends ht{constructor(){super(...arguments);this.isNewConversation=true;this.messages=[];this.loading=false;this.botImage=Ut.BOT}render(){return z`
		...
		`}renderTimestampDivider(){return wt(this.isNewConversation,(()=>z`
			...
			`))}renderLoadingIndicator(){return this.loading?z`<div class="bot-message-container">
			  ...
			  </div>`:null}};Ht.styles=[xt,Ot];t([mt()],Ht.prototype,"isNewConversation",void 0);t([gt({type:Array})],Ht.prototype,"messages",void 0);t([gt({type:Boolean})],Ht.prototype,"loading",void 0);t([gt({type:String})],Ht.prototype,"botImage",void 0);Ht=t([ct("chat-message-list")],Ht);const Dt=a`
	.input-area {
		display: flex;
		padding: 16px;
...
`;let Rt=class t extends ht{constructor(){super(...arguments);this.inputValue="";this.sendMsgEnableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage.svg";this.sendMsgDisableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage_disable.svg"}render(){return z`
		...
		`}handleInput(t){this.inputValue=t.target.value}handleKeyPress(t){if(t.key==="Enter"&&this.inputValue.trim())this.emitSendMessage()}handleSendClick(){this.emitSendMessage()}emitSendMessage(){this.dispatchEvent(new CustomEvent("send-message",{detail:{text:this.inputValue},bubbles:true,composed:true}));this.inputValue=""}};Rt.styles=[xt,Dt];t([mt()],Rt.prototype,"inputValue",void 0);t([gt({type:String})],Rt.prototype,"sendMsgEnableImage",void 0);t([gt({type:String})],Rt.prototype,"sendMsgDisableImage",void 0);Rt=t([ct("chat-input")],Rt);let Lt=class t extends ht{constructor(){super();this.botImage=Ut.BOT;this.sendMsgEnableImage=Ut.SEND_MESSAGE_ENABLE;this.sendMsgDisableImage=Ut.SEND_MESSAGE_DISABLE;this.closeChatIcon=Ut.CLOSE_CHAT;this.showCloseButton=false;this.buttonLabel="Close";this.theme={fontFamily:"Inter, sans-serif",headerBgColor:"#3e415b",headerTitleColor:"#ffffff",headerSubtitleColor:"#f5f8fc",messageContainerBgColor:"#ffffff",loaderColor:"#3e415b",botMsgBgColor:"#ffffff",botMsgBorderColor:"#e6ebf4",botMsgTextColor:"#30363c",userMsgBgColor:"#EBF2FF",userMsgTextColor:"#30363c",userMsgBorderColor:"#B5CDF7",inputBackgroundColor:"#ebf2ff",inputBorderColor:"#e6ebf4",inputTextColor:"#30363c",placeholderTextColor:"#8897a2"};this.isLoading=false;this.chatbotData={chatAPI:{body:{}},customerCareNumber:""};this.messages=[];this.conversationId="4bb91e16-7a12-44ee-9b16-25c9bddeb2da";this.showChatInput=true;this._handlePageClose=()=>{var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)};this.initializeSessionStorage()}connectedCallback(){super.connectedCallback();this.loadComponents()}initializeSessionStorage(){try{const t=sessionStorage.getItem("chatbotData");if(!t){const t={chatAPI:{body:{inputs:{user_id:"",session_id:""}}},customerCareNumber:""};sessionStorage.setItem("chatbotData",JSON.stringify(t));this.chatbotData=t}else this.chatbotData=JSON.parse(t)}catch(t){console.error("Error initializing session storage:>>>>>>",t)}}async loadComponents(){await Promise.all([this.loadHeaderComponent(),this.loadChatLoaderComponent(),this.loadTalkToAgentComponent()])}async loadHeaderComponent(){await Promise.resolve().then((function(){return Et}))}async loadChatLoaderComponent(){await import("./chat-loader-5f74a950.esm.js")}async loadTalkToAgentComponent(){await import("./talk-to-agent-e5edd0d8.esm.js")}async handleSendMessage(t){this.isLoading=true;const e=t.detail.text;this.addMessage({sender:"user",text:e,time:this.getCurrentTime()});try{const t=await _t.sendMessage({body:this.chatbotData.chatAPI.body,message:e,conversationId:this.conversationId});this.conversationId=t.conversation_id;const s=JSON.parse(t.answer).assistantLastMessage||"Sorry, I encountered an error. Please try again.";this.addMessage({sender:"bot",text:s,time:this.getCurrentTime()})}catch(t){this.addMessage({sender:"bot",text:"Sorry, I encountered an error. Please try again.",time:this.getCurrentTime()})}finally{this.isLoading=false}}addMessage(t){this.messages=[...this.messages,t];this.requestUpdate();this.scrollToBottom()}async scrollToBottom(){await this.updateComplete;const t=this.shadowRoot;if(!t)return;const e=t.querySelector("chat-message-list");if(!e)return;const s=e.shadowRoot;if(!s)return;const i=s.querySelector(".chat-container");if(!i)return;i.scrollTo({top:i.scrollHeight,behavior:"smooth"});i.scrollTop=i.scrollHeight}getCurrentTime(){return(new Date).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}render(){return z`
			...
			${this.showChatInput?z`<chat-input
				  ...
				  ></talk-to-agent>`}
		`}};Lt.styles=[xt];t([gt({type:Object})],Lt.prototype,"apiBody",void 0);t([gt({type:String})],Lt.prototype,"botImage",void 0);t([gt({type:String})],Lt.prototype,"sendMsgEnableImage",void 0);t([gt({type:String})],Lt.prototype,"sendMsgDisableImage",void 0);t([gt({type:String})],Lt.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],Lt.prototype,"onCloseChat",void 0);t([gt({type:Boolean,attribute:"show-close-button"})],Lt.prototype,"showCloseButton",void 0);t([gt({type:String,attribute:"button-label"})],Lt.prototype,"buttonLabel",void 0);t([gt({type:Object})],Lt.prototype,"theme",void 0);t([mt()],Lt.prototype,"isLoading",void 0);t([mt()],Lt.prototype,"chatbotData",void 0);t([mt()],Lt.prototype,"messages",void 0);t([mt()],Lt.prototype,"conversationId",void 0);t([mt()],Lt.prototype,"showChatInput",void 0);Lt=t([ct("ai-chat")],Lt);export{Lt as A,Bt as D,t as _,Ut as a,xt as c,ct as e,a as i,gt as n,ht as s,z as x};
