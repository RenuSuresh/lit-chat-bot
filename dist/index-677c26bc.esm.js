...
`;let Ot=class t extends ht{constructor(){super(...arguments);this.timestamp=""}get displayTimestamp(){const t={hour:"2-digit",minute:"2-digit"};return new Intl.DateTimeFormat(navigator.language,t).format(this.date)}render(){return z`
		...
		`}};Ot.styles=[ft,Bt];t([gt({type:String})],Ot.prototype,"timestamp",void 0);t([gt({type:Date})],Ot.prototype,"date",void 0);Ot=t([dt("timestamp-divider")],Ot);const Rt=a`
	.chat-container {
...
`;var Pt;(function(t){t["INFO"]="info"})(Pt||(Pt={}));const Lt=a`
	:host {
		display: block;
		width: 100vw;
		margin-left: -16px;
...
`;let Nt=class t extends ht{constructor(){super(...arguments);this.message=""}get displayMessage(){if(this.info)return this.info.message;return this.message}render(){var t;return Mt((t=this.displayMessage)===null||t===void 0?void 0:t.trim(),(()=>z` <div class="chat-info-strip">${this.displayMessage}</div> `),(()=>z``))}};Nt.styles=[ft,Lt];t([gt({type:Object})],Nt.prototype,"info",void 0);t([gt({type:String})],Nt.prototype,"message",void 0);Nt=t([dt("chat-info-strip")],Nt);const Dt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ht=t=>(...e)=>({_$litDirective$:t,values:e});class Ut{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class jt extends Ut{constructor(t){if(super(t),this.et=q,t.type!==Dt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===q||null==t)return this.ft=void 0,this.et=t;if(t===F)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}}jt.directiveName="unsafeHTML",jt.resultType=1;const zt=Ht(jt);const Ft=a`
	.bot-message-container,
...
`;let Wt=class t extends ht{render(){return z`
		...
		`}};Wt.styles=Yt;Wt=t([dt("chat-loader")],Wt);var Jt=Object.freeze({__proto__:null,get ChatLoader(){return Wt}});let Kt=class t extends($t(ht)){constructor(){super(...arguments);this.isNewConversation=true;this.botImage=bt.BOT;this.isConversationClosed=false;this.isStartChatReached=false;this.isTransferCallReached=false;this.chatContainer=null;this.observer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback();if(this.observer)this.observer.disconnect()}firstUpdated(){var t;this.chatContainer=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector(".chat-container");if(this.chatContainer&&this.observer)this.observer.observe(this.chatContainer,{childList:true,characterData:true,subtree:true});this.scrollToBottom()}updated(t){var e;super.updated(t);if(t.has("chatContext")){const s=((e=t.get("chatContext"))===null||e===void 0?void 0:e.messages)||[];const o=this.chatContext.messages;if(o.length>s.length)requestAnimationFrame((()=>{setTimeout((()=>{this.scrollToBottom()}),50)}))}if(t.has("isConversationClosed")||t.has("isStartChatReached")||t.has("isTransferCallReached"))this.scrollToBottom()}scrollToBottom(){requestAnimationFrame((()=>{if(this.chatContainer)this.chatContainer.scrollTo({top:this.chatContainer.scrollHeight,behavior:"smooth"})}))}renderTimestampDivider(){return Mt(this.isNewConversation,(()=>z`
			...
			`),(()=>z` <user-message .message=${t}></user-message> `))}renderLoadingIndicator(){return this.chatContext.isLoading?z`<div class="bot-message-container">
			  ...
			  </div>`:null}getStartChatInfo(){return{type:Pt.INFO,message:"You've reached the start of the conversation."}}getConversationCloseInfo(){return{type:Pt.INFO,message:"✅ This conversation has been closed"}}getTransferCallInfo(){return{type:Pt.INFO,message:"Transferring your call to one of our support executive"}}render(){return z`
		...
		`}forceScrollToBottom(){requestAnimationFrame((()=>{setTimeout((()=>{this.scrollToBottom()}),50)}))}};Kt.styles=[ft,Rt];t([mt()],Kt.prototype,"isNewConversation",void 0);t([gt({type:String})],Kt.prototype,"botImage",void 0);t([gt({type:Boolean})],Kt.prototype,"isConversationClosed",void 0);t([gt({type:Boolean})],Kt.prototype,"isStartChatReached",void 0);t([gt({type:Boolean})],Kt.prototype,"isTransferCallReached",void 0);Kt=t([dt("chat-message-list")],Kt);const Gt=a`
	.input-area {
		display: flex;
		padding: 16px;
...
`;const Xt=72;let Zt=class t extends ht{constructor(){super(...arguments);this.inputValue="";this.sendMsgEnableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage.svg";this.sendMsgDisableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage_disable.svg"}render(){return z`
	...
	`;t([gt({type:Number})],te.prototype,"rating",void 0);t([gt({type:Boolean})],te.prototype,"submitted",void 0);te=t([dt("feedback-content")],te);let ee=class t extends ht{constructor(){super(...arguments);this.open=false;this.rating=0;this.submitted=false}handleClose(){this.submitted=false;this.rating=0;this.open=false;this.dispatchEvent(new CustomEvent("close"))}handleSubmit(){this.submitted=true;this.dispatchEvent(new CustomEvent("submit",{detail:this.rating}));setTimeout((()=>{this.handleClose()}),3e3)}handleRatingSelect(t){this.rating=t.detail.rating}render(){return z`
		...
		`}};t([gt({type:Boolean,reflect:true})],ee.prototype,"open",void 0);t([gt({type:Number})],ee.prototype,"rating",void 0);t([gt({type:Boolean})],ee.prototype,"submitted",void 0);ee=t([dt("feedback-bottom-sheet")],ee);let se=class t extends($t(ht)){constructor(){super(...arguments);this.botImage=bt.BOT;this.sendMsgEnableImage=bt.SEND_MESSAGE_ENABLE;this.sendMsgDisableImage=bt.SEND_MESSAGE_DISABLE;this.closeChatIcon=bt.CLOSE_CHAT;this.showCloseButton=false;this.buttonLabel="Close";this.theme={fontFamily:"Inter, sans-serif",headerBgColor:"#3e415b",headerTitleColor:"#ffffff",headerSubtitleColor:"#f5f8fc",messageContainerBgColor:"#ffffff",loaderColor:"#3e415b",botMsgBgColor:"#ffffff",botMsgBorderColor:"#e6ebf4",botMsgTextColor:"#30363c",userMsgBgColor:"#EBF2FF",userMsgTextColor:"#30363c",userMsgBorderColor:"#B5CDF7",inputBackgroundColor:"#ebf2ff",inputBorderColor:"#e6ebf4",inputTextColor:"#30363c",placeholderTextColor:"#8897a2"};this.showChatInput=true;this.showFeedbackDrawer=false;this.rating=0;this.chatInputObserver=null;this._handlePageClose=()=>{var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)}}handleEndConversation(){this.showFeedbackDrawer=true}handleRatingSelect(t){this.rating=t.detail.rating}async submitFeedback(){try{await St.submitFeedback({rating:this.rating,conversationId:this.chatContext.conversationId});this.showFeedbackDrawer=false}catch(t){console.error("Error submitting feedback:",t)}}connectedCallback(){super.connectedCallback();this.initializeSessionStorage();this.loadComponents();this.chatContext.updateTheme(this.theme)}firstUpdated(){var t;const e=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector("chat-input");if(e){this.chatInputObserver=new ResizeObserver((t=>{for(const e of t){const t=e.contentRect.height+58;this.style.setProperty("--chat-input-height",`${t}px`)}}));this.chatInputObserver.observe(e)}}disconnectedCallback(){if(this.chatInputObserver)this.chatInputObserver.disconnect();super.disconnectedCallback()}initializeSessionStorage(){try{const t=sessionStorage.getItem("chatbotData");if(!t){const t={chatAPI:{body:{inputs:{userId:"39783010",parentOrderId:"525744916255784960"},user:"Rakesh"},headers:{},theme:{}},customerCareNumber:""};sessionStorage.setItem("chatbotData",JSON.stringify(t));this.chatContext.setChatbotData(t)}else{const e=JSON.parse(t);this.chatContext.setChatbotData(e)}}catch(t){console.error("Error initializing session storage:",t)}}async loadComponents(){await Promise.all([this.loadHeaderComponent(),this.loadChatLoaderComponent(),this.loadTalkToAgentComponent()])}async loadHeaderComponent(){await Promise.resolve().then((function(){return It}))}async loadChatLoaderComponent(){await Promise.resolve().then((function(){return Jt}))}async loadTalkToAgentComponent(){await import("./talk-to-agent-9700e22a.esm.js")}async handleSendMessage(t){var e,s,o;this.chatContext.setLoading(true);const i=t.detail.text;this.chatContext.addMessage({sender:"user",text:i,time:this.getCurrentTime()});const n=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("chat-message-list");if(n)n.forceScrollToBottom();const r=(s=this.shadowRoot)===null||s===void 0?void 0:s.querySelector("chat-input");if(r){const t=(o=r.shadowRoot)===null||o===void 0?void 0:o.querySelector("textarea");if(t){t.style.height="auto";t.style.height="18px"}}try{const t=await St.sendMessage({body:this.chatContext.chatbotData.chatAPI.body,message:i,conversationId:this.chatContext.conversationId});this.chatContext.setConversationId(t.conversation_id);const e=JSON.parse(t.answer).assistantLastMessage||"Sorry, I encountered an error. Please try again.";this.chatContext.addMessage({sender:"bot",text:e,time:this.getCurrentTime()});if(n)n.forceScrollToBottom()}catch(t){this.chatContext.addMessage({sender:"bot",text:"Sorry, I encountered an error. Please try again.",time:this.getCurrentTime()});if(n)n.forceScrollToBottom()}finally{this.chatContext.setLoading(false)}if(i.includes("no, thanks")||i.includes("no thanks")||i.includes("that's all"))this.handleEndConversation()}async scrollToBottom(){var t,e;await new Promise((t=>requestAnimationFrame(t)));const s=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector("chat-message-list");if(s){const t=(e=s.shadowRoot)===null||e===void 0?void 0:e.querySelector(".chat-container");if(t)t.scrollTo({top:t.scrollHeight,behavior:"smooth"})}}getCurrentTime(){return(new Date).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}render(){return z`
			<style>
				:host {
		...
		`}};se.styles=[ft];t([gt({type:Object})],se.prototype,"apiBody",void 0);t([gt({type:String})],se.prototype,"botImage",void 0);t([gt({type:String})],se.prototype,"sendMsgEnableImage",void 0);t([gt({type:String})],se.prototype,"sendMsgDisableImage",void 0);t([gt({type:String})],se.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],se.prototype,"onCloseChat",void 0);t([gt({type:Boolean,attribute:"show-close-button"})],se.prototype,"showCloseButton",void 0);t([gt({type:String,attribute:"button-label"})],se.prototype,"buttonLabel",void 0);t([gt({type:Object})],se.prototype,"theme",void 0);t([mt()],se.prototype,"showChatInput",void 0);t([mt()],se.prototype,"showFeedbackDrawer",void 0);t([mt()],se.prototype,"rating",void 0);se=t([dt("ai-chat")],se);export{se as A,yt as D,t as _,bt as a,ft as c,dt as e,a as i,gt as n,ht as s,z as x};
