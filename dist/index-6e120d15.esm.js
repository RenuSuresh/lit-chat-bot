...
`;let Et=class t extends ht{constructor(){super(...arguments);this.closeChatIcon=""}handleCloseChat(){var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)}render(){return z`
			<div class="header">
				<img
		...
		`}};Et.styles=[ft,Tt];t([gt({type:String})],Et.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],Et.prototype,"onCloseChat",void 0);Et=t([dt("chat-header")],Et);var It=Object.freeze({__proto__:null,get ChatHeader(){return Et}});function Bt(t,e,s){return t?e():null==s?void 0:s()}const Mt=a`
...
`;let Ot=class t extends ht{constructor(){super(...arguments);this.timestamp=""}get displayTimestamp(){const t={hour:"2-digit",minute:"2-digit"};return new Intl.DateTimeFormat(navigator.language,t).format(this.date)}render(){return z`
		...
		`}};Ot.styles=[ft,Mt];t([gt({type:String})],Ot.prototype,"timestamp",void 0);t([gt({type:Date})],Ot.prototype,"date",void 0);Ot=t([dt("timestamp-divider")],Ot);const Pt=a`
	.chat-container {
...
`;var Nt;(function(t){t["INFO"]="info"})(Nt||(Nt={}));const Rt=a`
	:host {
		display: block;
		width: 100vw;
		margin-left: -16px;
...
`;let qt=class t extends ht{constructor(){super(...arguments);this.botImage=""}render(){return z`
		...
		`}};qt.styles=[ft,Ft];t([gt({type:Object})],qt.prototype,"message",void 0);t([gt({type:String})],qt.prototype,"botImage",void 0);qt=t([dt("bot-message")],qt);let Vt=class t extends ht{render(){return z`
...
`;let Wt=class t extends ht{render(){return z`
		...
		`}};Wt.styles=Yt;Wt=t([dt("chat-loader")],Wt);var Jt=Object.freeze({__proto__:null,get ChatLoader(){return Wt}});let Kt=class t extends(wt(ht)){constructor(){super(...arguments);this.isNewConversation=true;this.botImage=bt.BOT;this.isConversationClosed=false;this.isStartChatReached=false;this.isTransferCallReached=false;this.chatContainer=null;this.observer=null}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback();if(this.observer)this.observer.disconnect()}firstUpdated(){var t;this.chatContainer=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector(".chat-container");if(this.chatContainer&&this.observer)this.observer.observe(this.chatContainer,{childList:true,characterData:true,subtree:true});this.scrollToBottom()}updated(t){var e;super.updated(t);if(t.has("chatContext")){const s=((e=t.get("chatContext"))===null||e===void 0?void 0:e.messages)||[];const i=this.chatContext.messages;if(i.length>s.length)requestAnimationFrame((()=>{setTimeout((()=>{this.scrollToBottom()}),50)}))}if(t.has("isConversationClosed")||t.has("isStartChatReached")||t.has("isTransferCallReached"))this.scrollToBottom()}scrollToBottom(){requestAnimationFrame((()=>{if(this.chatContainer)this.chatContainer.scrollTo({top:this.chatContainer.scrollHeight,behavior:"smooth"})}))}renderTimestampDivider(){return Bt(this.isNewConversation,(()=>z`
			...
			`),(()=>z` <user-message .message=${t}></user-message> `))}renderLoadingIndicator(){return this.chatContext.isLoading?z`<div class="bot-message-container">
			  ...
			  </div>`:null}getStartChatInfo(){return{type:Nt.INFO,message:"You've reached the start of the conversation."}}getConversationCloseInfo(){return{type:Nt.INFO,message:"✅ This conversation has been closed"}}getTransferCallInfo(){return{type:Nt.INFO,message:"Transferring your call to one of our support executive"}}render(){return z`
			<div class="chat-container">
				${this.renderTimestampDivider()}
				${Bt(this.isStartChatReached,(()=>z`
						<chat-info-strip .info=${this.getStartChatInfo()}></chat-info-strip>
					`))}
				${this.chatContext.messages.map((t=>this.renderMessage(t)))}
				${this.renderLoadingIndicator()}
				${Bt(this.isConversationClosed,(()=>z`
						<chat-info-strip
							.info=${this.isTransferCallReached?this.getTransferCallInfo():this.getConversationCloseInfo()}
						></chat-info-strip>
					`))}
			</div>
		`}forceScrollToBottom(){requestAnimationFrame((()=>{setTimeout((()=>{this.scrollToBottom()}),50)}))}};Kt.styles=[ft,Pt];t([mt()],Kt.prototype,"isNewConversation",void 0);t([gt({type:String})],Kt.prototype,"botImage",void 0);t([gt({type:Boolean})],Kt.prototype,"isConversationClosed",void 0);t([gt({type:Boolean})],Kt.prototype,"isStartChatReached",void 0);t([gt({type:Boolean})],Kt.prototype,"isTransferCallReached",void 0);Kt=t([dt("chat-message-list")],Kt);const Gt=a`
	.input-area {
		display: flex;
		padding: 16px;
...
`;const Xt=72;let Zt=class t extends ht{constructor(){super(...arguments);this.inputValue="";this.sendMsgEnableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage.svg";this.sendMsgDisableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage_disable.svg"}render(){return z`
	...
	`;t([gt({type:Boolean,reflect:true})],Qt.prototype,"open",void 0);t([gt({type:String})],Qt.prototype,"position",void 0);t([gt({type:Boolean})],Qt.prototype,"isClosing",void 0);Qt=t([dt("base-drawer")],Qt);let te=class t extends ht{constructor(){super(...arguments);this.rating=0;this.submitted=true}handleSubmit(){this.submitted=true;this.dispatchEvent(new CustomEvent("submit",{detail:this.rating}))}handleStarClick(t){this.rating=t;this.dispatchEvent(new CustomEvent("rating-select",{detail:{rating:t}}))}renderThankYou(){return z`
		...
		`}render(){return this.submitted?this.renderThankYou():this.renderFeedbackForm()}};te.styles=a`
		:host {
			display: block;
			text-align: center;
		}
	...
	`;t([gt({type:Boolean})],se.prototype,"open",void 0);t([gt({type:String})],se.prototype,"title",void 0);t([gt({type:String})],se.prototype,"subtitle",void 0);t([gt({type:String})],se.prototype,"primaryButtonText",void 0);t([gt({type:String})],se.prototype,"secondaryButtonText",void 0);t([gt({type:Number})],se.prototype,"inactivityTimeout",void 0);t([gt({type:String})],se.prototype,"phoneNumber",void 0);se=t([dt("popup-drawer")],se);let ie=class t extends(wt(ht)){constructor(){super(...arguments);this.botImage=bt.BOT;this.sendMsgEnableImage=bt.SEND_MESSAGE_ENABLE;this.sendMsgDisableImage=bt.SEND_MESSAGE_DISABLE;this.closeChatIcon=bt.CLOSE_CHAT;this.showCloseButton=false;this.buttonLabel="Close";this.theme={fontFamily:"Inter, sans-serif",headerBgColor:"#3e415b",headerTitleColor:"#ffffff",headerSubtitleColor:"#f5f8fc",messageContainerBgColor:"#ffffff",loaderColor:"#3e415b",botMsgBgColor:"#ffffff",botMsgBorderColor:"#e6ebf4",botMsgTextColor:"#30363c",userMsgBgColor:"#EBF2FF",userMsgTextColor:"#30363c",userMsgBorderColor:"#B5CDF7",inputBackgroundColor:"#ebf2ff",inputBorderColor:"#e6ebf4",inputTextColor:"#30363c",placeholderTextColor:"#8897a2"};this.showChatInput=true;this.showFeedbackDrawer=false;this.rating=0;this.showInactivityPopup=false;this.inactivityTimer=null;this.INACTIVITY_TIMEOUT=5e3;this.hasUserDismissedPopup=false;this.chatInputObserver=null;this._handlePageClose=()=>{var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)}}handleEndConversation(){this.showFeedbackDrawer=true}handleRatingSelect(t){this.rating=t.detail.rating}async submitFeedback(){try{await At.submitFeedback({rating:this.rating,conversationId:this.chatContext.conversationId});this.showFeedbackDrawer=false}catch(t){console.error("Error submitting feedback:",t)}}resetInactivityTimer(){if(this.inactivityTimer)window.clearTimeout(this.inactivityTimer);if(!this.hasUserDismissedPopup)this.inactivityTimer=window.setTimeout((()=>{this.showInactivityPopup=true}),this.INACTIVITY_TIMEOUT)}handleInputActivity(){if(!this.hasUserDismissedPopup){this.showInactivityPopup=false;this.resetInactivityTimer()}}connectedCallback(){super.connectedCallback();this.initializeSessionStorage();this.loadComponents();this.chatContext.updateTheme(this.theme);this.resetInactivityTimer()}firstUpdated(){var t;const e=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector("chat-input");if(e){this.chatInputObserver=new ResizeObserver((t=>{for(const e of t){const t=e.contentRect.height+58;this.style.setProperty("--chat-input-height",`${t}px`)}}));this.chatInputObserver.observe(e)}}disconnectedCallback(){if(this.chatInputObserver)this.chatInputObserver.disconnect();super.disconnectedCallback();if(this.inactivityTimer)window.clearTimeout(this.inactivityTimer)}initializeSessionStorage(){try{const t=sessionStorage.getItem("chatbotData");if(!t){const t={chatAPI:{body:{inputs:{userId:"39783010",parentOrderId:"525744916255784960"},user:"Rakesh"},headers:{},theme:{}},customerCareNumber:""};sessionStorage.setItem("chatbotData",JSON.stringify(t));this.chatContext.setChatbotData(t)}else{const e=JSON.parse(t);this.chatContext.setChatbotData(e)}}catch(t){console.error("Error initializing session storage:",t)}}async loadComponents(){await Promise.all([this.loadHeaderComponent(),this.loadChatLoaderComponent(),this.loadTalkToAgentComponent()])}async loadHeaderComponent(){await Promise.resolve().then((function(){return It}))}async loadChatLoaderComponent(){await Promise.resolve().then((function(){return Jt}))}async loadTalkToAgentComponent(){await import("./talk-to-agent-d28d76d6.esm.js")}async handleSendMessage(t){var e,s,i;this.handleInputActivity();this.chatContext.setLoading(true);const o=t.detail.text;this.chatContext.addMessage({sender:"user",text:o,time:this.getCurrentTime()});const r=(e=this.shadowRoot)===null||e===void 0?void 0:e.querySelector("chat-message-list");if(r)r.forceScrollToBottom();const n=(s=this.shadowRoot)===null||s===void 0?void 0:s.querySelector("chat-input");if(n){const t=(i=n.shadowRoot)===null||i===void 0?void 0:i.querySelector("textarea");if(t){t.style.height="auto";t.style.height="18px"}}try{const t=await At.sendMessage({body:this.chatContext.chatbotData.chatAPI.body,message:o,conversationId:this.chatContext.conversationId});this.chatContext.setConversationId(t.conversation_id);const e=JSON.parse(t.answer).assistantLastMessage||"Sorry, I encountered an error. Please try again.";this.chatContext.addMessage({sender:"bot",text:e,time:this.getCurrentTime()});if(r)r.forceScrollToBottom()}catch(t){this.chatContext.addMessage({sender:"bot",text:"Sorry, I encountered an error. Please try again.",time:this.getCurrentTime()});if(r)r.forceScrollToBottom()}finally{this.chatContext.setLoading(false)}if(o.includes("no, thanks")||o.includes("no thanks")||o.includes("that's all"))this.handleEndConversation()}async scrollToBottom(){var t,e;await new Promise((t=>requestAnimationFrame(t)));const s=(t=this.shadowRoot)===null||t===void 0?void 0:t.querySelector("chat-message-list");if(s){const t=(e=s.shadowRoot)===null||e===void 0?void 0:e.querySelector(".chat-container");if(t)t.scrollTo({top:t.scrollHeight,behavior:"smooth"})}}getCurrentTime(){return(new Date).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}render(){return z`
			<style>
				:host {
		...
		`}};ie.styles=[ft];t([gt({type:Object})],ie.prototype,"apiBody",void 0);t([gt({type:String})],ie.prototype,"botImage",void 0);t([gt({type:String})],ie.prototype,"sendMsgEnableImage",void 0);t([gt({type:String})],ie.prototype,"sendMsgDisableImage",void 0);t([gt({type:String})],ie.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],ie.prototype,"onCloseChat",void 0);t([gt({type:Boolean,attribute:"show-close-button"})],ie.prototype,"showCloseButton",void 0);t([gt({type:String,attribute:"button-label"})],ie.prototype,"buttonLabel",void 0);t([gt({type:Object})],ie.prototype,"theme",void 0);t([mt()],ie.prototype,"showChatInput",void 0);t([mt()],ie.prototype,"showFeedbackDrawer",void 0);t([mt()],ie.prototype,"rating",void 0);t([mt()],ie.prototype,"showInactivityPopup",void 0);ie=t([dt("ai-chat")],ie);export{ie as A,yt as D,t as _,bt as a,ft as c,dt as e,a as i,gt as n,ht as s,z as x};
