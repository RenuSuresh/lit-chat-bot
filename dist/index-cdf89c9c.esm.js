...
`;let Ut=class t extends ht{constructor(){super(...arguments);this.timestamp=""}get displayTimestamp(){const t={hour:"2-digit",minute:"2-digit"};return new Intl.DateTimeFormat(navigator.language,t).format(this.date)}render(){return z`
		...
		`}};Ut.styles=[At,Pt];t([gt({type:String})],Ut.prototype,"timestamp",void 0);t([gt({type:Date})],Ut.prototype,"date",void 0);Ut=t([ct("timestamp-divider")],Ut);const Nt=a`
	.chat-container {
...
`;let Ot=class t extends ht{constructor(){super(...arguments);this.isNewConversation=true;this.messages=[];this.loading=false;this.botImage="https://assets.pharmeasy.in/web-assets/images/image_chatbot.png"}render(){return z`
			<div class="chat-container">
				${this.renderTimestampDivider()}
				${this.messages.map((t=>this.renderMessage(t)))}
				${this.renderLoadingIndicator()}
			</div>
		`}renderTimestampDivider(){return Et(this.isNewConversation,(()=>z`
				<timestamp-divider
					.date=${new Date}
					.showFullDate=${true}
				></timestamp-divider>
			`))}renderMessage(t){return Et(t.sender==="bot",(()=>z`
			...
			`))}renderLoadingIndicator(){return this.loading?z`<div class="bot-message-container">
			  ...
			  </div>`:null}};Ot.styles=[At,Nt];t([mt()],Ot.prototype,"isNewConversation",void 0);t([gt({type:Array})],Ot.prototype,"messages",void 0);t([gt({type:Boolean})],Ot.prototype,"loading",void 0);t([gt({type:String})],Ot.prototype,"botImage",void 0);Ot=t([ct("chat-message-list")],Ot);const Ht=a`
	.input-area {
		display: flex;
		padding: 16px;
...
`;let Rt=class t extends ht{constructor(){super(...arguments);this.inputValue="";this.sendMsgEnableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage.svg";this.sendMsgDisableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage_disable.svg"}render(){return z`
		...
		`}handleInput(t){this.inputValue=t.target.value}handleKeyPress(t){if(t.key==="Enter"&&this.inputValue.trim())this.emitSendMessage()}handleSendClick(){this.emitSendMessage()}emitSendMessage(){this.dispatchEvent(new CustomEvent("send-message",{detail:{text:this.inputValue},bubbles:true,composed:true}));this.inputValue=""}};Rt.styles=[At,Ht];t([mt()],Rt.prototype,"inputValue",void 0);t([gt({type:String})],Rt.prototype,"sendMsgEnableImage",void 0);t([gt({type:String})],Rt.prototype,"sendMsgDisableImage",void 0);Rt=t([ct("chat-input")],Rt);let Bt=class t extends ht{constructor(){super();this.botImage="";this.sendMsgEnableImage="";this.sendMsgDisableImage="";this.closeChatIcon="https://assets.pharmeasy.in/web-assets/images/ic_close.svg";this.showCloseButton=false;this.buttonLabel="Close";this.theme={fontFamily:"Inter, sans-serif",headerBgColor:"#3e415b",headerTitleColor:"#ffffff",headerSubtitleColor:"#f5f8fc",messageContainerBgColor:"#ffffff",loaderColor:"#3e415b",botMsgBgColor:"#ffffff",botMsgBorderColor:"#e6ebf4",botMsgTextColor:"#30363c",userMsgBgColor:"#EBF2FF",userMsgTextColor:"#30363c",userMsgBorderColor:"#B5CDF7",inputBackgroundColor:"#ebf2ff",inputBorderColor:"#e6ebf4",inputTextColor:"#30363c",placeholderTextColor:"#8897a2"};this.isLoading=false;this.chatbotData={};this.messages=[{sender:"bot",text:"Hi Manthan, I am easybot. I am here to help you with your concern",time:this.getCurrentTime()},{sender:"user",text:"Hi Manthan, I am easybot. I am here to help you with your concern",time:this.getCurrentTime()}];this.conversationId="";this.showChatInput=true;this._handlePageClose=()=>{var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)};this.chatbotData=JSON.parse(sessionStorage.getItem("chatbotData")||"{}")}connectedCallback(){super.connectedCallback();this.loadHeaderComponent();this.loadChatLoaderComponent();this.loadTalkToAgentComponent()}async loadHeaderComponent(){await Promise.resolve().then((function(){return wt}))}async loadChatLoaderComponent(){await import("./chat-loader-d2d052ce.esm.js")}async loadTalkToAgentComponent(){await import("./talk-to-agent-70afcedf.esm.js")}async handleSendMessage(t){this.isLoading=true;const e=t.detail.text;this.addMessage({sender:"user",text:e,time:this.getCurrentTime()});try{const t=await _t.sendMessage({body:this.chatbotData.chatAPI.body,message:e,conversationId:this.conversationId});this.conversationId=t.conversation_id;const s=JSON.parse(t.answer).assistantLastMessage||"Sorry, I encountered an error. Please try again.";this.addMessage({sender:"bot",text:s,time:this.getCurrentTime()})}catch(t){this.addMessage({sender:"bot",text:"Sorry, I encountered an error. Please try again.",time:this.getCurrentTime()})}finally{this.isLoading=false}}addMessage(t){this.messages=[...this.messages,t];this.requestUpdate();this.scrollToBottom()}async scrollToBottom(){await this.updateComplete;const t=this.shadowRoot;if(!t)return;const e=t.querySelector("chat-message-list");if(!e)return;const s=e.shadowRoot;if(!s)return;const i=s.querySelector(".chat-container");if(!i)return;i.scrollTo({top:i.scrollHeight,behavior:"smooth"});i.scrollTop=i.scrollHeight}getCurrentTime(){return(new Date).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}render(){return z`
			...
			${this.showChatInput?z`<chat-input
				  ...
				  ></chat-input>`:z`<talk-to-agent></talk-to-agent>`}
		`}};Bt.styles=[At];t([gt({type:Object})],Bt.prototype,"apiBody",void 0);t([gt({type:String})],Bt.prototype,"botImage",void 0);t([gt({type:String})],Bt.prototype,"sendMsgEnableImage",void 0);t([gt({type:String})],Bt.prototype,"sendMsgDisableImage",void 0);t([gt({type:String})],Bt.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],Bt.prototype,"onCloseChat",void 0);t([gt({type:Boolean,attribute:"show-close-button"})],Bt.prototype,"showCloseButton",void 0);t([gt({type:String,attribute:"button-label"})],Bt.prototype,"buttonLabel",void 0);t([gt({type:Object})],Bt.prototype,"theme",void 0);t([mt()],Bt.prototype,"isLoading",void 0);t([mt()],Bt.prototype,"chatbotData",void 0);t([mt()],Bt.prototype,"messages",void 0);t([mt()],Bt.prototype,"conversationId",void 0);t([mt()],Bt.prototype,"showChatInput",void 0);Bt=t([ct("ai-chat")],Bt);export{Bt as A,t as _,At as c,ct as e,a as i,ht as s,z as x};
