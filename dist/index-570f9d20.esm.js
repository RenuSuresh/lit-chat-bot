...
`;let Et=class t extends ht{constructor(){super(...arguments);this.closeChatIcon=""}handleCloseChat(){var t;(t=this.onCloseChat)===null||t===void 0?void 0:t.call(this)}render(){return j`
			<div class="header">
				<img
		...
		`}};Et.styles=[ft,Tt];t([gt({type:String})],Et.prototype,"closeChatIcon",void 0);t([gt({attribute:false})],Et.prototype,"onCloseChat",void 0);Et=t([dt("chat-header")],Et);var It=Object.freeze({__proto__:null,get ChatHeader(){return Et}});function Mt(t,e,s){return t?e():null==s?void 0:s()}const Bt=a`
...
`;const Xt=72;const Zt=200;let Qt=class t extends($t(ht)){constructor(){super(...arguments);this.inputValue="";this.charCount=0;this.sendMsgEnableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage.svg";this.sendMsgDisableImage="https://assets.pharmeasy.in/web-assets/images/icon_sendMessage_disable.svg"}render(){return j`
